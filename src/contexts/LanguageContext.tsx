...
const translations = {
  en: {
    ...
    pricing_basic_price: '$2,500',
    pricing_business_price: '$7,500',
    pricing_enterprise_price: 'Custom',
    pricing_basic_desc: 'Perfect for startups and MVPs',
    pricing_business_desc: 'For growing businesses scaling fast',
    pricing_enterprise_desc: 'Full-scale enterprise solutions',
    pricing_select: 'Select Plan',
    pricing_contact: 'Contact Sales',
    pricing_popular: 'Most Popular',
    pricing_mo: '/project',

    pricing_feat_basic_1: 'Up to 10 pages / screens',
    pricing_feat_basic_2: 'Responsive design',
    pricing_feat_basic_3: '2 revision rounds',
    pricing_feat_basic_4: '30-day support',
    pricing_feat_basic_5: 'Source code delivery',
    pricing_feat_business_1: 'Up to 30 pages / screens',
    pricing_feat_business_2: 'Custom UI/UX design',
    pricing_feat_business_3: 'API integrations',
    pricing_feat_business_4: '5 revision rounds',
    pricing_feat_business_5: '90-day support',
    pricing_feat_business_6: 'Analytics dashboard',
    pricing_feat_enterprise_1: 'Unlimited scope',
    pricing_feat_enterprise_2: 'Dedicated team',
    pricing_feat_enterprise_3: 'Custom architecture',
    pricing_feat_enterprise_4: 'Unlimited revisions',
    pricing_feat_enterprise_5: '12-month support',
    pricing_feat_enterprise_6: 'SLA guarantee',
    ...
    ai_call_title: 'AI Sales Consultant',
    ai_call_subtitle: 'Live Technical Consultation',
    ai_call_status_connecting: 'Connecting...',
    ai_call_status_connected: 'Connected',
    ai_call_status_idle: 'Ready',
    ai_call_agent_name: 'Nova - Senior Technical Consultant',
    ai_call_agent_role: 'AI-Powered Sales Engineer',
    ...
    trust_verified_upwork: 'Verified on Upwork',

    service_hero_cta: 'Get Started',
  ...
  ar: {
    ...
    pricing_basic_desc: 'مثالي للشركات الناشئة والمنتجات الأولية',
    pricing_business_desc: 'للأعمال المتنامية بسرعة',
    pricing_enterprise_desc: 'حلول مؤسسية متكاملة',
    pricing_select: 'اختر الخطة',
    pricing_contact: 'تواصل مع المبيعات',
    pricing_popular: 'الأكثر شيوعاً',
    pricing_mo: '/مشروع',

    pricing_feat_basic_1: 'حتى 10 صفحات / شاشات',
    pricing_feat_basic_2: 'تصميم متجاوب',
    pricing_feat_basic_3: 'جولتا مراجعة',
    pricing_feat_basic_4: 'دعم 30 يوماً',
    pricing_feat_basic_5: 'تسليم الكود المصدري',
    pricing_feat_business_1: 'حتى 30 صفحة / شاشة',
    pricing_feat_business_2: 'تصميم UI/UX مخصص',
    pricing_feat_business_3: 'تكامل API',
    pricing_feat_business_4: '5 جولات مراجعة',
    pricing_feat_business_5: 'دعم 90 يوماً',
    pricing_feat_business_6: 'لوحة تحليلات',
    pricing_feat_enterprise_1: 'نطاق غير محدود',
    pricing_feat_enterprise_2: 'فريق مخصص',
    pricing_feat_enterprise_3: 'هندسة معمارية مخصصة',
    pricing_feat_enterprise_4: 'مراجعات غير محدودة',
    pricing_feat_enterprise_5: 'دعم 12 شهراً',
    pricing_feat_enterprise_6: 'ضمان اتفاقية مستوى الخدمة',
    ...
    ai_call_title: 'مستشار المبيعات الذكي',
    ai_call_subtitle: 'استشارة تقنية مباشرة',
    ai_call_status_connecting: 'جاري الاتصال...',
    ai_call_status_connected: 'متصل',
    ai_call_status_idle: 'جاهز',
    ai_call_agent_name: 'نوفا - مستشار تقني أول',
    ai_call_agent_role: 'مهندس مبيعات مدعوم بالذكاء الاصطناعي',
    ...
    trust_verified_upwork: 'موثق على Upwork',

    service_hero_cta: 'ابدأ الآن',
